...
if(isset($_POST['page'])){
  ...
  elseif ( !empty($dept) ) {
    $whereSQL = " WHERE department = '".$dept."' ";
  }
  ...
  //get number of rows
  $queryNum = $DB_con->query("SELECT COUNT(*) as postNum FROM `faculty_soap` JOIN `faculties` ON `faculties`.`FacultyID`=`faculty_soap`.`FacultyID` JOIN `department` ON `faculties`.`dept`=`department`.`dept_id` $whereSQL $orderSQL");
  ...
  //get rows
  $query = $DB_con->query("SELECT * FROM `faculty_soap` JOIN `faculties` ON `faculties`.`FacultyID`=`faculty_soap`.`FacultyID` JOIN `department` ON `faculties`.`dept`=`department`.`dept_id` $whereSQL $orderSQL LIMIT $start,$limit");
  ...
  //get number of rows
  $queryNum = $DB_con->query("SELECT COUNT(*) as postNum FROM `faculty_soap` JOIN `faculties` ON `faculties`.`FacultyID`=`faculty_soap`.`FacultyID` JOIN `department` ON `faculties`.`dept`=`department`.`dept_id`");
  $resultNum = $queryNum->fetch_assoc();
  $rowCount = $resultNum['postNum'];
  ...
  //get rows
  $query = $DB_con->query("SELECT * FROM `faculty_soap` JOIN `faculties` ON `faculties`.`FacultyID`=`faculty_soap`.`FacultyID` JOIN `department` ON `faculties`.`dept`=`department`.`dept_id` ORDER BY date_checked DESC LIMIT $limit");
