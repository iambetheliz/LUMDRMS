...
include('../../includes/Pagination.php');
  ...
  //get rows
  $query = $DB_con->query("SELECT * FROM `students_med` JOIN `students` ON `students`.`StudentID`=`students_med`.`StudentID` JOIN `program` ON `students`.`program`=`program`.`program_id` ORDER BY last_name ASC");
