...
<title>Student Medical Records | Laguna University - Clinic | Medical Records System</title>
        ...
        <ul class="sidebar-nav" role="menu">                    
          ...
          <li class="active have-child" role="presentation">
            ...
            <ul id="demo" class="panel-collapse collapse in">
              ...
              <li class="active">
                <a role="submenuitem" data-toggle="collapse"><span class="fa fa-medkit"></span>&nbsp;&nbsp; Medical <i class="fa fa-caret-down"></i></a>
      ...
      <div id="page-content-wrapper">
        <div class="page-content">
          <div class="container-fluid">   
            ...
            <div class="row">
              <div class="container-fluid">
                <h1 class="page-header">Students' Medical Records
