      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right top-menu">
          ...
          <?php
            if(!empty($userRow)){?>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="col-1 fa fa-user-circle" aria-hidden="true"></i><?php echo $userRow['userName']; ?><i class="col-1"></i><i class="col-1 fa fa-caret-down" aria-hidden="true"></i></a>
