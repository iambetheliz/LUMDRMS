...
include('../../includes/Pagination.php');
  ...
  //get rows
  $query = $DB_con->query("SELECT * FROM `faculty_med` JOIN `faculties` ON `faculties`.`FacultyID`=`faculty_med`.`FacultyID` JOIN `department` ON `faculties`.`dept`=`department`.`dept_id` ORDER BY last_name ASC");
